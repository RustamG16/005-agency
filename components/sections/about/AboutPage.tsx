...
import { AtlasSequence } from "./AboutInteractions";
...
const { orchestration, proof, cta } = about;
...
function OrchestrationSection() {
  return (
    <AtlasSequence>
      <section className={styles.atlas} aria-labelledby="about-atlas-title">
...
function ProofSection() {
  return (
    <section className={styles.section} aria-labelledby="about-proof-title">
      <RegistrationCross corners={["tr", "br"]} />

      <div className={styles.proofHead}>
        <SectionIndex index={proof.index} label={proof.label} />
        <Heading id="about-proof-title" lines={proof.heading} />
...
function CtaSection() {
  return (
    <section className={styles.cta} aria-labelledby="about-cta-title">
      ...
      <Heading id="about-cta-title" lines={cta.heading} size="hero" />
