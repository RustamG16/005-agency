/**
 * capture-about-v3.mjs — evidence capture for the /about-v3 lockup rebuild.
 *
 ...
 *
 *   node scripts/capture-about-v3.mjs
 *   node scripts/capture-about-v3.mjs --base http://localhost:4328
 *   node scripts/capture-about-v3.mjs --only mobile
 */
...
const SECTIONS = [
  ...
  ["02-founders", "#about-v3-founders"],
  ["03-arrival", "[aria-labelledby='about-v3-arrival-title']"],
  ["04-analysis", "[aria-labelledby='about-v3-analysis-title']"],
  ["05-programs", "[aria-labelledby='about-v3-programs-title']"],
  ["06-intake", "[aria-labelledby='about-v3-intake-title']"],
  ["07-atlas", "[aria-labelledby='about-v3-atlas-title']"],
  ["08-delivery", "[aria-labelledby='about-v3-delivery-title']"],
  ["09-proof", "[aria-labelledby='about-v3-proof-title']"],
  ["10-cta", "[aria-labelledby='about-v3-cta-title']"],
];
...
for (const vp of VIEWPORTS) {
  ...
  await page.goto(`${BASE}/about-v3`, { waitUntil: "networkidle", timeout: 90_000 });
