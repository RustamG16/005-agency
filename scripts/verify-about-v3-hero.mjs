/**
 * verify-about-v3-hero.mjs — scroll-state QA for the /about-v3 hero banner and
 * the re-paced journey sequence.
 *
 * Companion to `verify-about-v3.mjs`, which covers behaviour (focus order, tap
 ...
 *
 *   OUT=./shots TAG=desktop node scripts/verify-about-v3-hero.mjs
 *   OUT=./shots TAG=mobile VW=390 VH=844 node scripts/verify-about-v3-hero.mjs
 *   OUT=./shots TAG=reduced REDUCED=1 node scripts/verify-about-v3-hero.mjs
 */
...
await page.goto(`${BASE}/about-v3`, { waitUntil: "networkidle", timeout: 90000 });
...
if (heroInfo) {
  ...
  for (const p of [0, 0.15, 0.28, 0.32, 0.5, 0.7, 1.0]) {
    await at(p);
