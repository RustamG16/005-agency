/**
 * verify-about.mjs — behavioural QA for the /about-v3 lockup rebuild.
 *
 ...
 * 44px.
 *
 *   node scripts/verify-about.mjs --base http://localhost:4330
 */
...
/* ── mobile ──────────────────────────────────────────────────────────────── */
{
  ...
  const mobile = await page.evaluate(() => {
    ...
    const order = [...document.querySelectorAll("#about-founders h3, #about-founders [role='img']")].map((el) =>
